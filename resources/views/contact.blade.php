<x-guest-layout>
    <!-- Hero Section -->
    <section class="relative overflow-hidden bg-gradient-to-br from-rose-900 to-pink-700">
            ...
            <div class="text-center text-white">
                <div class="mb-8">
                    <div
                        ...
                        <span class="text-rose-200 font-semibold text-lg">We're Here to Help</span>
                    </div>
                </div>
                <h1 class="text-5xl md:text-6xl lg:text-7xl font-bold leading-tight mb-6">
                    Get In <span
                        class="text-rose-300 bg-gradient-to-r from-rose-300 to-pink-300 bg-clip-text text-transparent">Touch</span>
                </h1>
                <p class="text-xl md:text-2xl leading-relaxed text-rose-100 max-w-3xl mx-auto mb-8">
                    We're here to help. Reach out to us and we'll respond within 24 hours.
                </p>
                <div class="w-24 h-1 bg-gradient-to-r from-rose-300 to-pink-300 mx-auto rounded-full"></div>
                <!-- Floating elements -->
                <div class="absolute top-20 left-10 w-20 h-20 bg-white/10 rounded-full animate-pulse"></div>
                <div class="absolute bottom-20 right-10 w-16 h-16 bg-rose-300/20 rounded-full animate-bounce"></div>
            </div>
        </div>
    </section>
    ...
    <div class="min-h-screen bg-gradient-to-br from-gray-50 to-white">
        <section class="py-20">
            <div class="max-w-7xl mx-auto px-4">
                <div class="text-center mb-16">
                    <div
                        class="inline-block px-4 py-2 bg-rose-100 text-rose-800 rounded-full text-sm font-semibold mb-4">
                        Reach Out
                    </div>
                    <h2 class="text-4xl md:text-5xl font-bold text-gray-900 mb-6">Get In Touch With Us</h2>
                    <p class="text-xl text-gray-600 max-w-3xl mx-auto">We're here to help with all your healthcare
                        staffing needs</p>
                            ...
                            <div class="relative z-10">
                                ...
                                <div class="space-y-6">
                                    <div class="flex items-start space-x-4">
                                        <div
                                            class="w-12 h-12 bg-rose-100 rounded-lg flex items-center justify-center flex-shrink-0">
                                    ...
                                    <div class="flex items-start space-x-4">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-gray-600">healthcare@Visitingangelshealth.com</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="flex items-start space-x-4">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-gray-600">15426 Bevanwood Dr<br>Woodbridge, VA 22193-5716</p>
                                        </div>
                                    </div>
                                </div>
                                <!-- Decorative elements -->
                                <div class="absolute -top-4 -right-4 w-24 h-24 bg-rose-100 rounded-full opacity-50">
                                </div>
                                <div class="absolute -bottom-4 -left-4 w-16 h-16 bg-pink-100 rounded-full opacity-50">
                                </div>
                            </div>
                        </div>
                        <!-- Business Hours -->
                            ...
                            <div class="relative z-10">
                                ...
                                <div class="space-y-3">
                                    ...
                                    <div class="flex justify-between">
                                        ...
                                        <span class="font-semibold text-gray-900">Emergency Only</span>
                                    </div>
                                </div>
                                <!-- Decorative elements -->
                                <div class="absolute -top-4 -right-4 w-20 h-20 bg-rose-100 rounded-full opacity-50">
                                </div>
                                <div class="absolute -bottom-4 -left-4 w-12 h-12 bg-pink-100 rounded-full opacity-50">
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <section class="py-20 bg-gradient-to-r from-rose-50 to-pink-50 relative overflow-hidden">
            <div class="absolute inset-0 bg-[url('data:image/svg+xml,%3Csvg width="60" height="60"
                ...
                fill-rule="evenodd"%3E%3Cg fill="%23fdf2f8" fill-opacity="0.1"%3E%3Ccircle cx="30"
            ...
            <div class="max-w-7xl mx-auto px-4 relative z-10">
                <div class="text-center mb-16">
                    ...
                    <h2 class="text-4xl font-bold text-gray-900 mb-6">Why Choose Visiting Angels?</h2>
                    <p class="text-xl text-gray-600 max-w-3xl mx-auto">We're committed to providing exceptional
                        healthcare staffing solutions with a personal touch.</p>
                    <div class="w-24 h-1 bg-gradient-to-r from-rose-600 to-pink-600 mx-auto rounded-full mt-6"></div>
                </div>
                ...
                <div class="grid md:grid-cols-3 gap-8">
                    <div
                        ...
                        <p class="text-gray-600 leading-relaxed">Round-the-clock assistance for all your healthcare
                            staffing needs.</p>
                    </div>
                    <div
                        class="bg-white rounded-2xl shadow-2xl shadow-gray-200 p-8 text-center hover:shadow-3xl transition-all duration-300 hover:-translate-y-2">
                        ...
                        <h3 class="text-2xl font-bold text-gray-900 mb-4">Trusted Care</h3>
                        <p class="text-gray-600 leading-relaxed">All our caregivers are thoroughly screened and
                    ...
                    <div
                        ...
                        <h3 class="text-2xl font-bold text-gray-900 mb-4">Compassionate Service</h3>
                        <p class="text-gray-600 leading-relaxed">We treat every client and caregiver with dignity,
