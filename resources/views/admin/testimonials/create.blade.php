...
<div class="p-6">
    ...
    <form action="{{ route('admin.testimonials.store') }}" method="POST" class="mt-6 grid md:grid-cols-2 gap-6">
        @csrf
        <div>
        ...
        <div>
            ...
            <input type="text" name="role" class="w-full border rounded-lg p-2 mt-1">
        </div>
        <div class="md:col-span-2">
            <label class="block text-sm">Quote</label>
            <textarea name="quote" rows="5" class="w-full border rounded-lg p-2 mt-1" required></textarea>
        </div>
        <div class="md:col-span-2">
